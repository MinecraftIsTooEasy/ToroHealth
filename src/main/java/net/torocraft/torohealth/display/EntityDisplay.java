    ...
    if (entity != null) {
      try {
        ...
        Quaternionf rotation = new Quaternionf()
            .rotationZ((float)Math.PI)  // Flip vertically to fix upside-down
            .rotateY(entity.getYRot() * ((float)Math.PI / 180.0f)); // Match entity's facing direction
        ...
        InventoryScreen.renderEntityInInventory(
            ...
            rotation,           // rotation  
            null,               // camera rotation (null = default)
